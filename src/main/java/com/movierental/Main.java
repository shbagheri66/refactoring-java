...
public class Main {
  ...
  public static void main(String[] args) {
    // No need for this Main class anymore as we have tests in the test folder
    // Just kept it here to show service is working as before even after refactoring
    ...
    String result = new RentalInfoService(InMemoryMovieRepository.getInstance()).getStatement(rentalHistory);
